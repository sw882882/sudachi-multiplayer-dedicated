...
cmake .. -GNinja -DSUDACHI_USE_BUNDLED_FFMPEG=ON -DSUDACHI_TESTS=OFF -DENABLE_LIBUSB=OFF -DCMAKE_BUILD_TYPE=Release -DENABLE_SDL2=OFF -DENABLE_QT=OFF -DENABLE_COMPATIBILITY_LIST_DOWNLOAD=OFF -DUSE_DISCORD_PRESENCE=OFF
ninja sudachi-room
strip ./bin/sudachi-room
